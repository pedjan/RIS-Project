...
<body>
	...
	<c:if test="${empty prijavljen}">
	    <div class="kontejner">
			<h2>Registruj se</h2>
			<form method="post" action="/Projekat/projekat/registracija">
				<label for="imePrezime" class="obavezno-polje">Ime i prezime:</label>	
				<input type="text" name="imePrezime" value=""><br>
				
				<label for="korIme" class="obavezno-polje">Korisnicko ime:</label>	
			...
			Imate nalog? <a href="prijava.jsp">Prijavi se</a>
		</div>
	</c:if>
	<c:if test="${!empty prijavljen}">
		<br>
